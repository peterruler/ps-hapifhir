...
class Info extends React.Component {
    render() {
        ...
        <img class="config-screen" src="/img/env-config.png" width="837" height="201" alt="env config screenshot"/>
        <p>Die Uri Parameter und Port werden für Links, Ajax Anfragen und den Nodemailer benötigt.</p>
        <hr />
        <img class="config-screen" src="/img/app-config.png" width="731" height="364" alt="app config screenshot"/>
